...
- [git](https://git-scm.com/) (estou usando a versão `2.45.1` enquanto escrevo esta aula)
- [Node.js](https://nodejs.org/en/) (estou usando a versão `v16.20.2` enquanto escrevo esta aula)
